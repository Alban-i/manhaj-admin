...
import { Timeline, ProfilesWithRoles } from '@/types/types';
...
import CreateArticleSheet from '@/app/[locale]/(root)/timelines/[slug]/components/create-article-sheet';
...
const TimelineViewer: React.FC<TimelineViewerProps> = ({
  ...
  // Get category name from timeline's category_id
  const timelineCategoryName = timeline.category_id
    ? categories.find((c) => c.id === timeline.category_id)?.name
    : undefined;
    ...
    return (
      <>
        ...
        <CreateArticleSheet
          ...
          timelineLanguage={timeline.language || 'ar'}
          timelineCategoryId={timeline.category_id ?? undefined}
